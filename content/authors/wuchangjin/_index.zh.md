    ...
    content:
      text: |-
        <div class="flex flex-col md:flex-row items-center md:items-start gap-6 my-6">
          ...
          <div>
            <h1 class="text-3xl font-bold">吴昌进</h1>
            <p class="text-gray-500 mt-1 mb-4">研究员 / 博士生导师</p>
            <p>中国科学院东莞材料科学与技术研究所研究员，博士生导师。主要从事活性物质物理、微纳米机器人设计制备、集群智能调控及其在精准医疗领域的应用研究。</p>
            <br>
            <p><strong>教育经历</strong></p>
            <p>博士 化学系，香港大学，2018–2021</p>
            <p>硕士 物理学，首尔国立大学，2015–2017</p>
            <p>学士 应用物理学，中国科学技术大学，2011–2015</p>
            <br>
            <p><strong>研究方向</strong></p>
            <p>活性物质与集群智能、微纳米机器人设计制备、精准医疗靶向给药、微流控器件</p>
            <a href="/uploads/wuchangjin-cv.pdf" class="btn btn-primary mt-4">下载完整简历</a>
          </div>
        </div>
    design:
      columns: '1'
